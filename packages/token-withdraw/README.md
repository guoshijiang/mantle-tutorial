...
`token-withdraw` shows how to move ERC20 tokens from Mantle (Layer 2) into Ethereum (Layer 1).
...
We use our [Mantle SDK](https://github.com/OffchainLabs/mantle-sdk) library for the token bridge interactions.
